...
Ensure that no other search tools such as locate, mlocate, or plocate are installed. If they are, you should uninstall them. See also the [troubleshooting](#troubleshooting) section.
